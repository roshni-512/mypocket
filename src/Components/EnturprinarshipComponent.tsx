  ...
  return (
    <>
      <section className="relative  bg-main">
        <div className="container flex flex-col lg:flex-row items-center lg:pt-10 lg:pb-10 ">
          <div className="flex flex-1 flex-col  lg:items-start lg:ml-10  pt-5">
            ...
            Entrepreneurship means <br></br>wanting to do more<br></br>
for the world  
            </h2>
            <p className=" text-lg lg:text-left mb-6  lg:ml-8 max-md:ml-2 lg:mt-5 text-white">
            Then you are entitled to ask for the same from us.
            </p>
